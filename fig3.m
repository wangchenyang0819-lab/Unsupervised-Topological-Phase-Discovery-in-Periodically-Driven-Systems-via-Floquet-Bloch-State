function combinedPlot()
    ...
    ax_a = subplot('Position', [0.05, 0.55, 0.40, 0.40]);
    ...
    ax_b = subplot('Position', [0.05, 0.05, 0.40, 0.40]);
    ...
    ax_c = subplot('Position', [0.50, 0.55, 0.35, 0.40]);
    plotPhaseSurface(ax_c, tpp, jiange);
    
    % Subplot (d): Eigenvalue diagram with PCA embedding
    ax_d = subplot('Position', [0.50, 0.05, 0.35, 0.40]);
    ...
    function plotEigenvaluesWithPCA(ax, e, score)
        ...
        set(ax, 'TickLabelInterpreter', 'latex', 'YTick', [0 1], 'FontSize', 24);
